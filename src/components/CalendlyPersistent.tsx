...
export function CalendlyPersistent() {
  ...
  return (
    <div 
      className={cn(
        "absolute top-0 left-0 w-full z-40 flex justify-center transition-opacity duration-500 pointer-events-none pt-16 md:pt-20",
        isVisible ? "opacity-100" : "opacity-0 invisible h-0"
      )}
    >
      <div className="container mx-auto px-6 max-w-7xl relative z-10 pt-12 md:pt-20">
        <div className="grid gap-12 lg:gap-24 items-start lg:grid-cols-12">
          {/* Espacio para la columna izquierda (vacío aquí) */}
          <div className="lg:col-span-6 xl:col-span-7" />

          {/* Columna Derecha: El Widget Real */}
